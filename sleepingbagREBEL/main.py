...
SYSTEM = (
    ...
    "Gebe ausschließlich die Informationen an nach denen der Nutzer gefragt hat"
    "Gebe keine Informationen an nach denen der Nutzer nicht gefragt hat."
    "Weise dezent auf den Newsletter hin (https://zenbivy.eu – rechts unten). "
    "Falls du die Frage nicht beantworten kannst sage ihnen das und weise daraufhin das sie mit einer E-Mail an friends@zenbivy.eu einen Menschen kontaktieren können "
    "Tool-Nutzung: "
    ...
    "• Wenn nichts gefunden wurde verwende 'rag' als letztes mittel."
    "verwende keine * die nerven"
)

_BASE_DIR = r"C:\Users\Fritz\Desktop\Python\sleepingbagREBEL\geschliffen"
...
def gear_guide(name: GuideKey) -> dict:
    ...
    Es stehen folgende Themen zur Auswahl: "Baue dein Schlafsystem", "Größentabelle", "Gebrauchsanweisung", "Füllgewicht",
    "Besitzerhandbuch", "Reparaturanleitung", "Putzanleitung", "Patents", "Kontakt", "Accessory Guide", "Give Away"
    """
    url = _SOURCES[name]
    try:
...
def bedingungen(kategorie: PolicyKey) -> str:
    ...
    Folgende Bedingungen stehen zur Auswahl: "Rabattcode", "Rückgabe- & Umtauschbedingungen", "Versandbedingungen"
    """
    POLICIES = {
        "Rückgabe- & Umtauschbedingungen": (
...
def wieder_verfuegbar(datei: DateiAuswahl) -> str:
    """
    Findet heraus wann etwas restocked/wieder verfuegbar ist.
    Es nimmt eine Produktkategorie als Eingabe und gibt aus wann jedes einzelne Produkt in dieser Kategorie wieder erhältlich ist
    es gibt folgende Kategorien: "Compression Caps", "Core  Quilt Double  -4°C", "Core Quilt -12°C", "Core Quilt -4°C", "Core Quilt -4°C Synthetic", "Core Sheet Double -4°C", "Core Sheet Down", "Core Sheet Synthetic", "Core Sheet Uninsulated", "Coupon EUR 50", "Ditty Dry Sack", "Double Flex 3D Mattress", "Double Luxe Sheet -4°C", "Double Quilt -4°C", "Down Pillow Topper", "Dry Sack", "Flex 3D Mattress", "Flex Air Mattress", "Flex Mattress", "Inflation Dry Sack", "Light Mattress", "Light Quilt +4°C Synthetic", "Light Quilt -12°C", "Light Quilt -20°C", "Light Quilt -4°C", "Light Quilt 2025 +4°C Synthetic", "Light Quilt 2025 -12°C", "Light Quilt 2025 -4°C", "Light Quilt Double  -4°C", "Light Sheet -12°C", "Light Sheet -20°C", "Light Sheet -4°C", "Light Sheet Double -4°C", "Light Sheet Uninsulated", "Mattress Repair Kit", "Max Pump 2 Pro", "Pillow Bladder", "Pillowcase", "Sonstiges", "Titan Bivy Mug Lid", "Ultralight Mattress", "Ultralight Muscovy Quilt -12°C", "Ultralight Muscovy Quilt -4°C", "Ultralight Muscovy Sheet -12°C", "Ultralight Muscovy Sheet -4°C", "Ultralight Quilt -12°C", "Ultralight Quilt -4°C", "Ultralight Sheet -12°C", "Ultralight Sheet -4°C", "Ultralight Sheet Uninsulated", "Zenbivy Bed -12°C", "Zenbivy Bed -4°C", "ZENBIVY VOUCHER", "Zip Sack", "Zipbed Overland -4°C Down", "Zipbed Overland -4°C Synthetic"
    """
